...
export interface Query {
    ...
    city: <T = ICity>(args: { cityId: ID_Output }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T | null> ,
    cities: <T = ICity[]>(args?: {}, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T> 
  }

export interface Mutation {
    addState: <T = State>(args: { state: StateInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T> ,
    addCity: <T = ICity>(args: { city: CityInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T> 
  }
...
export interface City extends ICity {
  id: ID_Output
  title: String
  state: State
}
